#############################################################
# Power analysis for discrete patterns
# Figure 4E, Supplementary Figure 20
#############################################################
...
library(ggplot2)
library(ggpubr)
InputPath_All <- c("../Data/Adl_Sim/discrete/")
...
for(SubFolder in SubFolders){
  ...
  png(file=paste0("../Outputs/Discrete_", SubFolder ,".png"),
